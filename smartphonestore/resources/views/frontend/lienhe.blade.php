...
@section('content')
    <div class="bg-light">
        <div class="container d-lg-flex justify-content-between py-2 py-lg-3 mb-4">
            <div class="order-lg-2 mb-3 mb-lg-0 pt-lg-2 mb-4">
    ...
    <section class="container-fluid pt-grid-gutter mb-4">
        <div class="row">
