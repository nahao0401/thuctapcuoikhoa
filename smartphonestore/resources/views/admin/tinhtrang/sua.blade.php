...
@section('content')
    ...
    @csrf
        ...
        <input type="text" class="form-control  @error('tinhtrang') is-invalid @enderror" id="tinhtrang" name="tinhtrang" value="{{ $tinhtrang->tinhtrang }}" value="{{ old('tinhtrang') }}" required />
        @error('tinhtrang')
