...
@section('content')
	<div class="card">
		...
		<div class="card-body table-responsive">
			<p>
				<a href="{{  route('admin.sanpham.them') }}" class="btn btn-primary"><i class="bi bi-plus"></i> Thêm mới</a>
				<a href="#nhap" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#importModal"><i class="bi bi-file-plus"></i> Nhập từ Excel</a>
				<a href="{{  route('admin.sanpham.xuat') }}" class="btn btn-success"><i class="bi bi-printer"></i> Xuất ra Excel</a>
			</p>
			{{ $sanpham->links() }}
				...
				<tbody>
					@foreach($sanpham as $value)
						<tr>
							...
							<td class="text-center"><a href="{{  route('admin.sanpham.sua', ['id' => $value->id]) }}"><i class="bi bi-gear"></i></a></td>
							<td class="text-center"><a href="{{  route('admin.sanpham.xoa', ['id' => $value->id]) }}" onclick="return confirm('Bạn có muốn xóa sản phẩm {{ $value->tensanpham }} không?')"><i class="bi bi-x-lg text-danger"></i></a></td>
						</tr>
					@endforeach
				</tbody>
			</table>
