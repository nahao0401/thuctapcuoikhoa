...
@section('content')
	<div class="card">
		...
		<div class="card-body table-responsive">
			<p>
				<a href="{{  route('admin.donhang.them') }}" class="btn btn-primary"><i class="bi bi-plus"></i> Thêm mới</a>
			</p>
				...
				<tbody>
					@foreach($donhang as $value)
						<tr>
							...
							<td class="text-center"><a href="{{  route('admin.donhang.sua', ['id' => $value->id]) }}"><i class="bi bi-gear"></i></a></td>
							<td class="text-center"><a href="{{  route('admin.donhang.xoa', ['id' => $value->id]) }}" onclick="return confirm('Bạn có muốn xóa đơn hàng của khách {{ $value->User->name }} không?')"><i class="bi bi-x-lg text-danger"></i></a></td>
						</tr>
					@endforeach
				</tbody>
			</table>
